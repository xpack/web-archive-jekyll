---
title:  xPack xpm v0.16.4 released
sidebar: xpm

summary: "Version **0.16.4** is a maintenance release, it fixes some bugs affecting list, uninstall and install with --copy."

version: 0.16.4

date: 2023-09-12 21:28:00 +0300

# --e-n-d-f--

# redirect_to: https://xpack.github.io/xpm/blog/2023/09/12/xpm-v0-16-4-released/
...
- [#184] - some URLs dependencies were not correctly identified; fixed
- [#188] - initialising npm packages failed; fixed, the `xpack` property
  is added
- [#189] - when creating new packages, the author name and email were
  not properly identified in the Git configuration; fixed

### Enhancements

- [#187] - add `--ignore-errors` to avoid breaking workflows when
  the project was already initialised
...
npm xpm@0.16.4 '/Users/ilg/.nvm/versions/node/v14.16.0/lib/node_modules/xpm'
