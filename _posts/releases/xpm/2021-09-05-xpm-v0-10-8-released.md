...
title:  xPack xpm v0.10.8 released
sidebar: xpm

summary: "Version **0.10.8** is a maintenance release; it adds --force-32bit to install."

version: 0.10.8

date: 2021-09-03 15:13:00 +0300

# --e-n-d-f--

# redirect_to: https://xpack.github.io/xpm/blog/2021/09/05/xpm-v0-10-8-released/
...
- [#116] for testing purposes, on 64-bit architectures it is sometimes
  necessary to install the 32-bit binaries; the option `--force-32bit` was added
  to the install command to force the selection of the 32-bit binaries.
...
npm xpm@0.10.8 '/Users/ilg/.nvm/versions/node/v14.16.0/lib/node_modules/xpm'
