...
title:  xPack xpm v0.15.2 released
sidebar: xpm

summary: "Version **0.15.2** is a maintenance release, it fixes some small bugs."

version: 0.15.2

date: 2023-05-23 08:21:00 +0300

# --e-n-d-f--

# redirect_to: https://xpack.github.io/xpm/blog/2023/05/23/xpm-v0-15-2-released/
...
- [#166] the `list` command failed with `ENOENT` if there were no
  packages installed; fixed
- [#167] for binary packages, if the archive download failed, the
  presence of the folder without .content prevented further installs;
  fixed.
...
npm xpm@0.15.2 '/Users/ilg/.nvm/versions/node/v14.16.0/lib/node_modules/xpm'
