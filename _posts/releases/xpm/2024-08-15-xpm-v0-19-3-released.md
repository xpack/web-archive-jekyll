...
title:  xPack xpm v0.19.3 released
sidebar: xpm

summary: "Version **0.19.3** is a maintenance release, it fixes shims on Windows (the ld.gold issue)."

version: 0.19.3

date: 2024-08-15 16:07:00 +0300
...
- [#206] in certain conditions, the logic behind the Windows shims failed and
some programs were not accessible (like `ld.gold`); fixed.
...
npm xpm@0.19.3 '/Users/ilg/.nvm/versions/node/v18.18.2/lib/node_modules/xpm'
