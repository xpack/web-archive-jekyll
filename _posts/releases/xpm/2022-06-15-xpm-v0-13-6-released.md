---
title:  xPack xpm v0.13.6 released
sidebar: xpm

summary: "Version **0.13.6** is a maintenance release; it fixes passing args to single command actions."

version: 0.13.6

date: 2022-06-15 19:27:00 +0300

# --e-n-d-f--

# redirect_to: https://xpack.github.io/xpm/blog/2022/06/15/xpm-v0-13-6-released/
...
- [#141] single command actions are allowed to take extra args form the
  command line, but, due to a bug, reported _optional arguments not
  supported for array of command_; fixed.
...
npm xpm@0.13.6 '/Users/ilg/.nvm/versions/node/v14.16.0/lib/node_modules/xpm'
