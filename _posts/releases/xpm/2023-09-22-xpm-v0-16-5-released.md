---
title:  xPack xpm v0.16.5 released
sidebar: xpm

summary: "Version **0.16.5** is a maintenance release, it fixes the bug affecting xpm init without git configuration."

version: 0.16.5

date: 2023-09-22 07:50:00 +0300

# --e-n-d-f--

# redirect_to: https://xpack.github.io/xpm/blog/2023/09/22/xpm-v0-16-5-released/
...
- [#190] - `xpm init` without a Git configuration failed; fixed
...
npm xpm@0.16.5 '/Users/ilg/.nvm/versions/node/v14.16.0/lib/node_modules/xpm'
