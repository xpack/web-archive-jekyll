...
title:  xPack xpm v0.16.1 released
sidebar: xpm

summary: "Version **0.16.1** is a new release, it adds support for `--copy` and hierarchical xpacks folder."

version: 0.16.1

date: 2023-06-03 08:16:00 +0300

# --e-n-d-f--

# redirect_to: https://xpack.github.io/xpm/blog/2023/06/03/xpm-v0-16-1-released/
...
- [#171] for environments where all sources must be inside the project, the
  `--copy` option was added to `install`

### Other changes

- [#170] the structure of the local `xpacks` folder was aligned with `npm`,
  and starting from `"minimumXpmRequired": "0.16.0"` uses two levels like
  `@scope/name`.
...
npm xpm@0.16.1 '/Users/ilg/.nvm/versions/node/v14.16.0/lib/node_modules/xpm'
