---
title:  xPack xpm v0.10.5 released
sidebar: xpm

summary: "Version **0.10.5** is a maintenance release; it adds warnings for extra xpm init args."

version: 0.10.5

date: 2021-06-20 21:55:00 +0300

# --e-n-d-f--

# redirect_to: https://xpack.github.io/xpm/blog/2021/06/20/xpm-v0-10-5-released/
...
- [#110] xpm init does not need args; warn if encountered.
