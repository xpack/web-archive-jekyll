---
title:  xPack xpm v0.12.10 released
sidebar: xpm

summary: "Version **0.12.10** is a maintenance release; it fixes a security issue."

version: 0.12.10

date: 2022-04-03 08:03:00 +0300

# --e-n-d-f--

# redirect_to: https://xpack.github.io/xpm/blog/2022/04/03/xpm-v0-12-10-released/
...
- an explicit dependency on minimist 1.2.5 was added to fix security issue
  GHSA-xvch-5gv4-984h
- the minimum node was updated to 12.x, as a prerequisite for some dependencies
