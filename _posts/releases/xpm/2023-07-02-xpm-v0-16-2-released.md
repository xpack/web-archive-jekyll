...
title:  xPack xpm v0.16.2 released
sidebar: xpm

summary: "Version **0.16.2** is a maintenance release, it fixes a bug in processing url dependencies."

version: 0.16.2

date: 2023-07-02 19:02:00 +0300

# --e-n-d-f--

# redirect_to: https://xpack.github.io/xpm/blog/2023/07/02/xpm-v0-16-2-released/
...
- [#171] - `xpm install` fails to install dependencies from `github:` when using the new dependencies format; fixed
...
npm xpm@0.16.2 '/Users/ilg/.nvm/versions/node/v14.16.0/lib/node_modules/xpm'
