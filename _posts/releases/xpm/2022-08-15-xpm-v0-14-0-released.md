---
title:  xPack xpm v0.14.0 released
sidebar: xpm

summary: "Version **0.14.0** is a new major release; it separates xPack from npm dependencies."

version: 0.14.0

date: 2022-08-15 18:28:00 +0300

# --e-n-d-f--

# redirect_to: https://xpack.github.io/xpm/blog/2022/08/15/xpm-v0-14-0-released/
...
introduces a breaking change due to the separate dependencies,
but this is handled by the compatibility policies.

### Bug fixes

- [#149] in certain conditions, `xpm list` did not show local packages; fixed
- [#148] the generated `minimumXpmRequired` might have pre-release parts; fixed

### Enhancements

- [#143] separate xPack from npm dependencies (breaking change! see
  [0001](https://xpack.github.io/xpm/policies/0001/) policy)
- [#147] add default empty properties in `package.json` for init
