---
title:  xPack xpm v0.19.1 released
sidebar: xpm

summary: "Version **0.19.1** is a new release, it fixes the dependencies bug and upgrades to node 18."

version: 0.19.1

date: 2024-03-10 13:58:00 +0200

# --e-n-d-f--

# redirect_to: https://xpack.github.io/xpm/blog/2024/03/10/xpm-v0-19-1-released/
...
- [#195] the message _error: installing standalone binary xPack
not supported, use --global_ was misleading, since the package was
already installed in the central store; fixed;
- [#196] using defaults in LiquidJS failed; update to latest module
using `lenientIf`.
...
npm xpm@0.19.1 '/Users/ilg/.nvm/versions/node/v14.16.0/lib/node_modules/xpm'
