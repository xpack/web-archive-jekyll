...
title:  xPack xpm v0.15.1 released
sidebar: xpm

summary: "Version **0.15.1** is a maintenance release, it fixes some Windows specific bugs."

version: 0.15.1

date: 2023-05-19 23:19:00 +0300

# --e-n-d-f--

# redirect_to: https://xpack.github.io/xpm/blog/2023/05/19/xpm-v0-15-1-released/

redirect_from:
  - /blog/2023/03/19/xpm-v0-15-1-released/
...
- [#165] on Windows, listing the global packages when running in the
  root folder failed with a permission error; fixed
- [#164] on Windows, instantiating templates failed with a `file://` error;
  fixed.
...
npm xpm@0.15.1 '/Users/ilg/.nvm/versions/node/v14.16.0/lib/node_modules/xpm'
