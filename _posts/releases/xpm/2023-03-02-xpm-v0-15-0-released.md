---
title:  xPack xpm v0.15.0 released
sidebar: xpm

summary: "Version **0.15.0** is a new release; it adds support for HTTP(S) proxy."
...
# redirect_to: https://xpack.github.io/xpm/blog/2023/03/02/xpm-v0-15-0-released/
...
- [#80] if a proxy was defined in the environment, it was used to download
  npm package, but not for the binary archives; fixed by passing an
  `HttpsProxyAgent` object to `node-fetch`.
...
npm xpm@0.15.0 '/Users/ilg/.nvm/versions/node/v14.16.0/lib/node_modules/xpm'
