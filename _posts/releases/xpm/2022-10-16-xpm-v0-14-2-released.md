---
title:  xPack xpm v0.14.2 released
sidebar: xpm

summary: "Version **0.14.2** is a new major release; it separates xPack from npm dependencies."

version: 0.14.2

date: 2022-10-16 22:09:00 +0300

# --e-n-d-f--

# redirect_to: https://xpack.github.io/xpm/blog/2022/10/16/xpm-v0-14-2-released/
...
- [#153] at install, in previous versions, the `node_modules` folder was
  purged before being recreated; now the `npm install` and `xpm install`
  are separate steps, and xpm must not touch the `node_modules` folder;
  fixed
...
npm xpm@0.14.2 '/Users/ilg/.nvm/versions/node/v14.16.0/lib/node_modules/xpm'
