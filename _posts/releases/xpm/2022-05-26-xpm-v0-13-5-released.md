...
title:  xPack xpm v0.13.5 released
sidebar: xpm

summary: "Version **0.13.5** is a maintenance release; it filters out hidden configurations in `install --all-configs`."

version: 0.13.5

date: 2022-05-26 17:35:00 +0300

# --e-n-d-f--

# redirect_to: https://xpack.github.io/xpm/blog/2022/05/26/xpm-v0-13-5-released/
...
- [#139] when installing dependencies for all build configurations,
  build folders were created even for the hidden configurations; fixed.
...
npm xpm@0.13.5 '/Users/ilg/.nvm/versions/node/v14.16.0/lib/node_modules/xpm'
