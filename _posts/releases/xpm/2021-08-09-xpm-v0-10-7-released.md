...
title:  xPack xpm v0.10.7 released
sidebar: xpm

summary: "Version **0.10.7** is a maintenance release; it fixes the missing --global in the Windows update check."

version: 0.10.7

date: 2021-08-09 12:24:00 +0300

# --e-n-d-f--

# redirect_to: https://xpack.github.io/xpm/blog/2021/08/09/xpm-v0-10-7-released/
...
- [#114] on Windows, the code used to recommend how to update to a new
  version was not able to identify that xpm is installed globally; as
  a temporary fix, on Windows now the code always recommends `--global`.
