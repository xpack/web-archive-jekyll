...
title:  xPack xpm v0.17.0 released
sidebar: xpm

summary: "Version **0.17.0** is a new release, it updates to node >= 16.14."

version: 0.17.0

date: 2023-09-26 10:25:00 +0300

# --e-n-d-f--

# redirect_to: https://xpack.github.io/xpm/blog/2023/09/26/xpm-v0-17-0-released/
...
- most of the dependencies now require node 16.14; in order to be able to use
  them, the project minimum node engine was updated to 16.14.
...
npm xpm@0.17.0 '/Users/ilg/.nvm/versions/node/v14.16.0/lib/node_modules/xpm'
