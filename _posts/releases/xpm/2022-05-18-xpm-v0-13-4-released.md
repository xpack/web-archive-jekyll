---
title:  xPack xpm v0.13.4 released
sidebar: xpm

summary: "Version **0.13.4** is a maintenance release; it fixes a small bug conducting to an irrelevant warning."

version: 0.13.4

date: 2022-05-18 18:00:00 +0300

# --e-n-d-f--

# redirect_to: https://xpack.github.io/xpm/blog/2022/05/18/xpm-v0-13-4-released/
...
- [#138] when installing packages, on macOS and GNU/Linux, symbolic links
  triggered warnings; the reason was the lack of a function to change
  the mode of the link itself; the problem was avoided by skipping
  symbolic links.
...
npm xpm@0.13.4 '/Users/ilg/.nvm/versions/node/v14.16.0/lib/node_modules/xpm'
