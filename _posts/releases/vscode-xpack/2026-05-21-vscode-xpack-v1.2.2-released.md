...
title:  VS Code xPack extension v1.2.2 released
sidebar: vscode

summary: "Version **1.2.2** is a maintenance release of **ilg-vscode.xpack**; it fixes a bug when invoking npm."
...
- [[#54](https://github.com/xpack/vscode-xpack-extension-ts/issues/54)]: when invoking npm run, the command was not properly configured; fixed.
